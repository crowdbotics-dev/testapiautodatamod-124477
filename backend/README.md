...
## Project Structure
    ...
    ├── testapiautodatamod_124477  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_124477`
...
2. Clone this repo and `cd testapiautodatamod_124477`
